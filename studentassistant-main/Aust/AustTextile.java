...
public class AustTextile extends MenuActivity implements BookAdapter.ClickListner{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aust_textile);
booksInfo=new Vector<>();
        ...
        recyclerView=findViewById(R.id.austTextileResycle);
