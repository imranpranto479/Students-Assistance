...
public class AustCse extends MenuActivity implements BookAdapter.ClickListner{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aust_cse);
        setTitle("AUST CSE Department");
booksInfo=new Vector<>();
        ...
        recyclerView=findViewById(R.id.austCseResycle);
