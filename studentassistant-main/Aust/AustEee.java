...
public class AustEee extends MenuActivity implements BookAdapter.ClickListner{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aust_eee);
        ...
        recyclerView=findViewById(R.id.austEeeResycle);
