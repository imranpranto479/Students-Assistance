...
public class NsuEee extends MenuActivity implements BookAdapter.ClickListner{
   ...
   Vector<Book>bookList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nsu_eee);
bookList=new Vector<>();
        ...
        recyclerView=findViewById(R.id.nsuEeeResycle);
