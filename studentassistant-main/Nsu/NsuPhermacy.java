...
public class NsuPhermacy extends MenuActivity implements BookAdapter.ClickListner{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nsu_phermacy);
        bookList=new Vector<>();
        ...
        recyclerView=findViewById(R.id.nsuPhermacyResycle);
