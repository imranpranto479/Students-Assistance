...
public class DiuEee extends MenuActivity implements BookAdapter.ClickListner {
...
Vector<Book>booksInfo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BookAdapter adapter=new BookAdapter(this,booksInfo,this);
        GridLayoutManager gridLayoutManager=new GridLayoutManager(this,2,GridLayoutManager.VERTICAL,false);
       recyclerView=findViewById(R.id.diuEeeRecycle);
