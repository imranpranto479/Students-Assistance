...
public class AiubPhermacy extends MenuActivity implements BookAdapter.ClickListner{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aiub_phermacy);
        ...
        recyclerView=findViewById(R.id.aiubPhermacyResycle);
