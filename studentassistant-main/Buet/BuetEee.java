...
public class BuetEee extends MenuActivity implements BookAdapter.ClickListner{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_buet_eee);
booksInfo=new Vector<>();
        ...
        recyclerView=findViewById(R.id.buetEeeResycle);
