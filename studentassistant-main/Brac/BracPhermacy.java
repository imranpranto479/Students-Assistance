...
public class BracPhermacy extends MenuActivity implements BookAdapter.ClickListner{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_brac_phermacy);
booksInfo=new Vector<>();
        ...
        recyclerView=findViewById(R.id.bracPhermacyResycle);
