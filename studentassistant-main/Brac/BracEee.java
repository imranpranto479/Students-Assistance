...
public class BracEee extends MenuActivity implements BookAdapter.ClickListner{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_brac_eee);
booksInfo=new Vector<>();
        ...
        recyclerView=findViewById(R.id.bracEeeResycle);
