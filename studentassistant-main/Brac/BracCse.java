...
public class BracCse extends MenuActivity implements BookAdapter.ClickListner{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_brac_cse);
booksInfo=new Vector<>();
        ...
        recyclerView=findViewById(R.id.bracCseResycle);
